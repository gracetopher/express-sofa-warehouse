<?php include("header.php"); ?>
		...
		<div class="product-page-slider">
			<div class="slider-wrapper theme-default">
				<div id="slider" class="nivoSlider editable"> 
					<img src="img/carol-white.jpg" alt="" title="" /> 
					<img src="img/carol-red.jpg" alt="" title="" /> 
					<img src="img/carol-brown.jpg" alt="" title="" />
				</div>
			</div>
		</div>
	  
	  <div class="product-page-content">
			<h2>palermo 3+2 sofa set </h2>
